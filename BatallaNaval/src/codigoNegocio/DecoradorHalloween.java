...
/**
 * DecoradorHalloween: Representa un objeto de tipo DecoradorTablero, en este 
 *                     caso, DecoradorHalloween encargado de decorar el Tablero
 *                     con la apariencia de Halloween.
 * 
 * @author Alberto Fernández Hernández
 * @author Francisco Cano Díaz
 */
public class DecoradorHalloween extends DecoradorTablero{

    /**
     * Constructor.
     * 
     * @param tablero Interface para la comunicación entre del DecoradorHalloween
     *                y el Tablero.
     */
    public DecoradorHalloween(TableroIF tablero) {
        super(tablero);
    }

    /**
     * Método encargado de cambiar la apariencia del Tablero, en este caso, a la
     * apariencia de Halloween.
     * 
    ...
    public void decorarTablero(LinkedHashMap<String, JLabel> casillasJugador,
        ...
        // establecer el icono de Halloween, si la casilla tiene un JLabel 
        ...
        for(JLabel casilla: casillasJugador.values()) {
            ...
            if(hayIconoPredeterminado || hayIconoHalloween || hayIconoNavidad) {
                ...
                casilla.setIcon(new ImageIcon(getClass().getResource("/interfaz/imagenes/CasillaTableroHalloween.png")));
            }
        }
        ...
        // Establecemos el fondo del Tablero con la apariencia de Halloween.
        JLabel fondo = new JLabel();
        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/interfaz/imagenes/FondoTableroHalloween.jpg")));
