...
/**
 * EstrategiaConcretaAcorazado: Representa un objeto de tipo EstrategiaAtaqueIA,
 *                              en este caso, EstrategiaConcretaAcorazado
 *                              encargado de los ataques del Navio Acorazado
 *                              de la IA.
 * 
 * @author Alberto Fernández Hernández
 * @author Francisco Cano Díaz
 */
public class EstrategiaConcretaAcorazado extends EstrategiaAtaqueIA {
     ...
     */
    public EstrategiaConcretaAcorazado(Tablero tableroJuego) {
        super(tableroJuego);
    }

    /**
     * Método encargado de realizar el ataque del Acorazado seleccionado
    ...
    public ArrayList<String> obtenerCasillasDeAtaque() {
        ...
        do{
            ...
            if( tipoDeAtaque <= probabilidadAtaqueNormal) { // Ataque normal.
                ...
                coordenadasAtaque.add(Character.toString((char) coordenadaInicio) + (numeroCoordenada + 1));
